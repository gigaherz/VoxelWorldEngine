...
namespace VoxelWorldEngine.Noise
{
    public class Simplex
    {
        ...
        public double Noise(double x, double y, int n, double alpha = 2, double beta = 2)
        {
            ...
            for (int i = 0; i < n; i++)
            {
                var val = SimplexNoise.Noise(x+offx, y+offy);
                sum += val / scale;
                scale *= alpha;
                x *= beta;
                y *= beta;
        ...
        public double Noise(double x, double y, double z, int n, double alpha = 2, double beta = 2)
        {
            ...
            for (int i = 0; i < n; i++)
            {
                var val = SimplexNoise.Noise(x+offx, y+offy, z+offz);
                sum += val / scale;
                scale *= alpha;
                x *= beta;
                y *= beta;
    ...
    {
        private static readonly Grad[] Grad3 = {new Grad(1,1,0),new Grad(-1,1,0),new Grad(1,-1,0),new Grad(-1,-1,0),
        ...
        private static readonly short[] Permutations = {
        ...
        private class Grad
        {
            ...
            internal Grad(double x, double y, double z)
            {
                this.x = x;
                this.y = y;
                this.z = z;
            ...
            internal Grad(double x, double y, double z, double w)
            {
                this.x = x;
                this.y = y;
                this.z = z;
